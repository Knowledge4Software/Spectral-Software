...
if __name__ == "__main__":
    run_spectral_tuning_cli(
        description="Tune Type-4 BCB spectral metric thresholds.",
        output_folder="outputs/bcb/type4",
        runner=lambda: run_bcb_metric_tuning("4", metrics=["pss"], stage_name="04_tune_pss_wasserstein"),
    )
