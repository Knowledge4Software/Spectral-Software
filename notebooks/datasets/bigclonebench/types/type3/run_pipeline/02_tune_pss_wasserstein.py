...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Tune merged Type-3 BCB spectral metric thresholds.")
    parser.add_argument(
        "--k-values",
    ...
    parser.add_argument(
        ...
        help="Optional number of pairs to sample. Ignored when balanced BCB non-clone sampling is enabled.",
    )
    parser.add_argument(
        "--optimize-for",
    ...
    print("[*] Output folder: outputs/bcb/type3/all")
    ...
    run_bcb_metric_tuning(CLONE_TYPE, metrics=METRICS, stage_name="02_tune_pss_wasserstein", variant=VARIANT)
