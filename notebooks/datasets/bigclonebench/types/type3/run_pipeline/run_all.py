...
STAGES = [
    ("01", "01_merge_type3_all.py"),
    ("02", "02_tune_pss_wasserstein.py"),
]


def main() -> None:
    parser = argparse.ArgumentParser(description="Run merged BCB Type-3 All pipeline stages in order.")
    parser.add_argument("--start-at", choices=[stage for stage, _ in STAGES], default="01")
    parser.add_argument("--stop-after", choices=[stage for stage, _ in STAGES], default="04")
    ...
    print("\n[+] All selected merged Type-3 All pipeline stages completed.")
