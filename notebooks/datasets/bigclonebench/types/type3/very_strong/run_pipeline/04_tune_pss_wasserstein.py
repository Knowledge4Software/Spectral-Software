...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Tune BCB Type-3 Very Strong spectral metric thresholds.")
    ...
    print("[*] Output folder: outputs/bcb/type3/very_strong")
