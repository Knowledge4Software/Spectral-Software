...
STAGES = [
    ...
    ("04", "04_tune_pss_wasserstein.py"),
]


def main() -> None:
    parser = argparse.ArgumentParser(description="Run all BCB Type-3 Very Strong pipeline stages in order.")
    ...
    print("\n[+] All selected Type-3 Very Strong pipeline stages completed.")
