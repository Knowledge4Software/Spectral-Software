...
if __name__ == "__main__":
    run_spectral_tuning_cli(
        description="Tune Type-1 BCB spectral metric thresholds.",
        output_folder="outputs/bcb/type1",
        runner=lambda: run_bcb_metric_tuning("1", metrics=["pss"], stage_name="04_tune_pss_wasserstein"),
    )
