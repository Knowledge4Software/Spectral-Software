...
if __name__ == "__main__":
    run_spectral_tuning_cli(
        description="Tune Semantic Benchmark Python spectral metric thresholds.",
        output_folder="outputs/semantic_benchmark/python",
        runner=lambda: run_pss_wasserstein_tuning(
            SectionConfig(dataset="semantic", variant="python", run_dir=Path(__file__).resolve().parent)
        ),
