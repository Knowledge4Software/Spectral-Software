...
if __name__ == "__main__":
    run_spectral_tuning_cli(
        description="Tune Semantic Benchmark C spectral metric thresholds.",
        output_folder="outputs/semantic_benchmark/c",
        runner=lambda: run_pss_wasserstein_tuning(
            SectionConfig(dataset="semantic", variant="c", run_dir=Path(__file__).resolve().parent)
        ),
