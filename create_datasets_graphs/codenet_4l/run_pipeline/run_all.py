...
Examples (from the repository root):
  python create_datasets_graphs/codenet_4l/run_pipeline/run_all.py --stop-after 01
  python create_datasets_graphs/codenet_4l/run_pipeline/run_all.py --sample-size 800 --stop-after 01 --force-prepare
"""
