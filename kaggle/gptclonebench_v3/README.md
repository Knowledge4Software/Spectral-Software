# GPTCloneBench V3 — Kaggle experiments

Attach `gptclonebench_v3_clean_data.zip` as the only Kaggle input. Each notebook discovers the clean-data folder/ZIP automatically.
