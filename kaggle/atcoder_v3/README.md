# ATCoder V3 — Kaggle experiments

Attach `atcoder_v3_clean_data.zip` as the only Kaggle input. Each notebook discovers the clean-data folder/ZIP automatically.
